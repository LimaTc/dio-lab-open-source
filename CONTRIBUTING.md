...
Utilize o comando `git checkout -b` para criar e alternar para a nova branch e nomeie-a como `feat/community/SEU_USERNAME`: `git checkou -b feat/community/SEU_USERNAME`;
> Exemplo:  `git checkou -b git checkout -b feat/community/falvojr`
